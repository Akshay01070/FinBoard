        ...
        endpoints: [
            ...
            },
            {
                ...
                defaultFields: [
                    ...
                    { path: 'market_cap_rank', label: 'Rank', format: 'number' },
                    { path: 'total_volume', label: 'Volume', format: 'number' },
        ...
        endpoints: [
            {
                ...
                defaultFields: [
                    { path: 'c', label: 'Price', format: 'currency' },
                    { path: 'dp', label: 'Change %', format: 'percentage' },
                    { path: 'o', label: 'Open', format: 'currency' },
        ...
        endpoints: [
            {
                ...
                defaultFields: [
                    ...
                    { path: 'open', label: 'Open', format: 'currency' },
                    { path: 'dayHigh', label: 'High', format: 'currency' },
                    { path: 'dayLow', label: 'Low', format: 'currency' },
                    { path: 'previousClose', label: 'Prev Close', format: 'currency' },
                    { path: 'totalTradedVolume', label: 'Volume', format: 'number' },
                    { path: 'high52', label: '52W High', format: 'currency' },
