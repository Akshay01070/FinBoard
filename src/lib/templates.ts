...
export const widgetTemplates: WidgetTemplate[] = [
    ...
    },
    {
        ...
        description: '14-day BTC OHLC candlestick chart',
        category: 'crypto',
        displayMode: 'chart',
        chartType: 'candlestick',
        apiUrl: 'https://api.coingecko.com/api/v3/coins/bitcoin/ohlc?vs_currency=usd&days=14',
        refreshInterval: 300,
        selectedFields: [],
        icon: '🕯️',
    },
    {
        id: 'eth-candlestick',
        name: 'Ethereum Candlestick',
        description: '14-day ETH OHLC candlestick chart',
        category: 'crypto',
        displayMode: 'chart',
        chartType: 'candlestick',
        apiUrl: 'https://api.coingecko.com/api/v3/coins/ethereum/ohlc?vs_currency=usd&days=14',
        refreshInterval: 300,
        selectedFields: [],
        icon: '🕯️',
    },
